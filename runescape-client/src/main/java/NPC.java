...
public final class NPC extends Actor {
	...
	protected final Model getModel() {
		if (this.npcComposition == null) {
			...
			if (this.field1363 != null && this.field1363.useLocalPlayer) {
				...
				var3 = this.npcComposition.getModel(var1, super.sequenceFrame, var2, super.movementFrame, this.field1363);
			}
	...
	final String method2656() {
		if (!this.field1365.isEmpty()) {
			...
			NPCComposition var1 = this.npcComposition;
			if (var1.transforms != null) {
				var1 = var1.transform();
				if (var1 == null) {
					var1 = this.npcComposition;
				}
			}
	...
	int[] method2661() {
		return this.field1362 != null ? this.field1362.method9898() : this.npcComposition.method3962();
	}
	...
	short[] method2662() {
		return this.field1362 != null ? this.field1362.method9895() : this.npcComposition.method3977();
	}
	...
	void method2663(int var1, int var2, short var3) {
		if (this.field1362 == null) {
			this.field1362 = new class546(this.npcComposition);
		}
	...
	final boolean isVisible() {
		return this.npcComposition != null;
	}
