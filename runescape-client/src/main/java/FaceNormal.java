...
public class FaceNormal {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		class7.method53(class358.topLevelWorldView, true);
		WorldView var4 = class358.topLevelWorldView;
		int var5 = var4.playerUpdateManager.playerSize;
		int[] var6 = var4.playerUpdateManager.playerIndexes;

		int var7;
		for (var7 = 0; var7 < var5; ++var7) {
			if (var6[var7] != Client.combatTargetPlayerIndex && var6[var7] != Client.localPlayerIndex) {
				class425.method7948(var4, var6[var7], true);
			}
		}

		class7.method53(class358.topLevelWorldView, false);
		WorldView var40 = class358.topLevelWorldView;

		int var9;
		int var11;
		int var41;
		for (var41 = 0; var41 < var40.worldEntitySize; ++var41) {
			WorldEntity var46 = var40.worldEntities[var40.worldEntityIndexes[var41]];
			if (var46 != null) {
				...
				class7.method53(var46.worldView, true);
				WorldView var47 = var46.worldView;
				var9 = var47.playerUpdateManager.playerSize;
				int[] var48 = var47.playerUpdateManager.playerIndexes;

				for (var11 = 0; var11 < var9; ++var11) {
					if (var48[var11] != Client.combatTargetPlayerIndex && var48[var11] != Client.localPlayerIndex) {
						class425.method7948(var47, var48[var11], true);
					}
				}

				class7.method53(var46.worldView, false);
		...
		int var8 = class33.field178;
		var9 = TextureProvider.field2830;
		int var10 = class76.field931;
		var11 = var41 * 3 + 600;
		int var14 = var3 - 334;
		if (var14 < 0) {
			var14 = 0;
		...
		if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (class33.field178 >> 7 != class17.localPlayer.x >> 7 || class76.field931 >> 7 != class17.localPlayer.y >> 7)) {
			var19 = class17.localPlayer.plane;
			var20 = (class33.field178 >> 7) + class358.topLevelWorldView.baseX;
			var21 = (class76.field931 >> 7) + class358.topLevelWorldView.baseY;
			...
			var22.packetBuffer.method9712(Client.field805);
					...
					if (Actor.cameraPitch < 310) {
						label626: {
							if (Client.oculusOrbState == 1) {
								var18 = class33.field178 >> 7;
								var19 = class76.field931 >> 7;
							} else {
								var18 = var16;
								var19 = var17;
							}
		...
		for (var42 = 0; var42 < class358.topLevelWorldView.worldEntitySize; ++var42) {
			WorldEntity var45 = class358.topLevelWorldView.worldEntities[class358.topLevelWorldView.worldEntityIndexes[var42]];
			if (var45 != null) {
		...
		var24 = -1;
		var25 = -1;
		int var26 = var49.playerUpdateManager.playerSize;
		int[] var27 = var49.playerUpdateManager.playerIndexes;

		int var28;
		for (var28 = 0; var28 < var26 + var49.npcSize; ++var28) {
			Object var44;
			if (var28 < var26) {
				...
				var44 = var49.NPCS[var49.npcIndexes[var28 - var26]];
			}

			class47.method886(var49, (Actor)var44, var28, var0, var1, var2, var3);
		}

		if (Client.renderSelf && var25 != -1) {
			class47.method886(var49, class17.localPlayer, var25, var0, var1, var2, var3);
		}

		if (var50) {
			class47.method886(var49, var49.players[Client.combatTargetPlayerIndex], var24, var0, var1, var2, var3);
		}
