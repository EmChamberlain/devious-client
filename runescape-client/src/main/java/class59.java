...
public class class59 {
	...
	static boolean method1147(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if (var5 == class379.field4408.field4411) {
			...
			if (var11 != null) {
				var11.field3021 = new DynamicObject(ModeWhere.worldView, class105.method2748(var11.field3029), var3, var4, var0, var1, var2, var6, false, var11.field3021);
				return true;
			}
		} else if (var5 == class379.field4410.field4411) {
			FloorDecoration var12 = var7.method4876(var0, var1, var2);
			if (var12 != null) {
				var12.renderable = new DynamicObject(ModeWhere.worldView, class105.method2748(var12.tag), 22, var4, var0, var1, var2, var6, false, var12.renderable);
				return true;
			}
		}
	...
	static void method1148(WorldView var0, PacketBuffer var1) {
		...
		if (var2 < var0.worldEntitySize) {
			throw new RuntimeException("dang");
		} else if (var2 > var0.worldEntitySize) {
			throw new RuntimeException("dang!");
		} else {
			var0.worldEntitySize = 0;

			int var3;
			int var4;
			for (var3 = 0; var3 < var2; ++var3) {
				var4 = var0.worldEntityIndexes[var3];
				WorldEntity var15 = var0.worldEntities[var4];
				boolean var6 = var1.readUnsignedByte() == 1;
				if (!var6) {
					var0.worldEntities[var4] = null;
				} else {
					var0.worldEntityIndexes[++var0.worldEntitySize - 1] = var4;
			...
			while (var1.method9604(Client.packetWriter.serverPacketLength) >= 10) {
				...
				var0.worldEntityIndexes[++var0.worldEntitySize - 1] = var3;
