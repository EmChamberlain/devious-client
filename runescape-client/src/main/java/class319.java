...
public class class319 {
	...
	static final void method6168(WorldView var0, int var1, int var2) {
		if (Client.hintArrowType == 2) {
			MenuAction.method2115(var0, Client.hintArrowSubX * 64 + (Client.field769 - var0.baseX << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - var0.baseY << 7), Client.hintArrowHeight * 2);
