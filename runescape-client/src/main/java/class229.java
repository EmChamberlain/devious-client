...
public class class229 extends Node {
	...
	static final void method4408(WorldView var0) {
		for (int var1 = 0; var1 < var0.npcSize; ++var1) {
			int var2 = var0.npcIndexes[var1];
			NPC var3 = var0.NPCS[var2];
			if (var3 != null) {
				GrandExchangeOfferOwnWorldComparator.updateActorSequence(var0, var3, var3.npcComposition.size);
			}
		}
