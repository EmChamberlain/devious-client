...
public class PlayerUpdateManager {
	...
	PlayerUpdateManager(WorldView var1) {
		...
		this.playerSize = 0;
		this.playerIndexes = new int[2048];
		this.field1426 = 0;
	...
	final void method2776(PacketBuffer var1, boolean var2) {
		...
		if (var2) {
			...
			class358.topLevelWorldView.players[var4] = var3;
		} else {
			this.field1411.players[var4] = var3;
		...
		int var8 = var5 & 16383;
		var3.pathX[0] = var7 - this.field1411.baseX;
		var3.x = (var3.pathX[0] << 7) + (var3.transformedSize() << 6);
		var3.pathY[0] = var8 - this.field1411.baseY;
		var3.y = (var3.pathY[0] << 7) + (var3.transformedSize() << 6);
		if (var2) {
			this.field1411.plane = var3.plane = var6;
		}
		...
		this.playerSize = 0;
		this.playerIndexes[++this.playerSize - 1] = var4;
	...
	final void method2778(PacketBuffer var1) {
		...
		int var5;
		int var6;
		for (var3 = 0; var3 < this.playerSize; ++var3) {
			var6 = this.playerIndexes[var3];
				...
				if (var2 != 0) {
					...
					if (var2 != 0) {
						...
						for (var3 = 1; var3 < 2048; ++var3) {
							...
							Player var4 = this.field1411.players[var3];
							if (var4 != null) {
								this.playerIndexes[++this.playerSize - 1] = var3;
							} else {
	...
	void method2780(PacketBuffer var1, int var2) {
		...
		Player var5 = this.field1411.players[var2];
		if (var4 == 0) {
			if (var3) {
				...
				this.field1419[var2] = (var5.plane << 28) + (this.field1411.baseX + var5.pathX[0] >> 13 << 14) + (this.field1411.baseY + var5.pathY[0] >> 13);
				if (var5.field1204 != -1) {
					this.field1420[var2] = var5.field1204;
				} else {
					this.field1420[var2] = var5.orientation;
				}

				this.field1409[var2] = var5.targetIndex;
				this.field1411.players[var2] = null;
			...
			if (var4 == 1) {
				...
				if (var6 == 0) {
					...
					if (var2 == Client.localPlayerIndex && this.field1411.method2634()) {
						this.field1411.plane = var5.plane;
					}
					...
					var9 = var7 >> 14 & 16383;
					var10 = var7 & 16383;
					var11 = (this.field1411.baseX + var9 + var5.pathX[0] & 16383) - this.field1411.baseX;
					var12 = (this.field1411.baseY + var10 + var5.pathY[0] & 16383) - this.field1411.baseY;
					if (var2 == Client.localPlayerIndex && this.field1411.method2634() && (var5.x < 1536 || var5.y < 1536 || var5.x >= 11776 || var5.y >= 11776)) {
						var5.resetPath(var11, var12);
						var5.field1161 = false;
					} else if (var3) {
	...
	boolean method2781(PacketBuffer var1, int var2) {
		...
		if (var3 == 0) {
			...
			if (this.field1411.players[var2] != null) {
				throw new RuntimeException();
			} else {
				Player var12 = this.field1411.players[var2] = new Player();
				var12.field1157 = var2;
				if (this.field1414[var2] != null) {
					var12.read(this.field1414[var2]);
				}

				var12.orientation = this.field1420[var2];
				var12.targetIndex = this.field1409[var2];
				var8 = this.field1419[var2];
				var9 = var8 >> 28;
				var10 = var8 >> 14 & 255;
				var11 = var8 & 255;
				var12.pathTraversed[0] = this.field1413[var2];
				var12.plane = (byte)var9;
				var12.resetPath((var10 << 13) + var4 - this.field1411.baseX, (var11 << 13) + var5 - this.field1411.baseY);
	...
	final void method2783(PacketBuffer var1, int var2, Player var3, int var4) {
		...
		if ((var4 & 32) != 0) {
			...
			if (var3.overheadText.charAt(0) == '~') {
				...
				UrlRequest.addGameMessage(2, var3.username.getName(), var3.overheadText);
		...
		if ((var4 & 1) != 0) {
			...
			if (var3.pathLength == 0) {
				var3.orientation = var3.field1204;
				var3.method2447();
			}
		}
		...
		if ((var4 & 1024) != 0) {
			...
			var3.spotAnimation = var1.readUnsignedShort() + Client.cycle;
			...
			if (var3.field1161) {
				...
				var3.field1256 += var3.pathX[0];
				var3.field1258 += var3.pathY[0];
				var3.field1257 += var3.pathX[0];
				var3.field1259 += var3.pathY[0];
				var3.pathLength = 1;
			}
		...
		if ((var4 & 8) != 0) {
			var3.targetIndex = var1.readUnsignedIntLE();
			var3.targetIndex += var1.readShortLE() << 16;
			var6 = 16777215;
