...
public enum class237 implements Enum {
	...
	static final void method4550() {
		if (class285.ClanChat_inClanChat) {
			...
			for (int var0 = 0; var0 < class358.topLevelWorldView.playerUpdateManager.playerSize; ++var0) {
				Player var1 = class358.topLevelWorldView.players[class358.topLevelWorldView.playerUpdateManager.playerIndexes[var0]];
	...
	static final void method4552(WorldView var0) {
		for (GraphicsObject var1 = (GraphicsObject)var0.graphicObjects.last(); var1 != null; var1 = (GraphicsObject)var0.graphicObjects.previous()) {
