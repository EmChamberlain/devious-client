...
public class class47 {
	...
	static final void method886(WorldView var0, Actor var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null && var1.isVisible()) {
			if (var1 instanceof NPC) {
				NPCComposition var7 = ((NPC)var1).npcComposition;
			...
			int var76 = var0.playerUpdateManager.playerSize;
			int[] var8 = var0.playerUpdateManager.playerIndexes;
			...
			if (var9) {
				...
				if (var91.field1136 != -1 || var91.field1137 != -1) {
					...
					if (Client.viewportTempX > -1) {
						if (var91.field1136 != -1) {
							var10 += 25;
							class4.headIconPkSprites[var91.field1136].drawTransBgAt(var3 + Client.viewportTempX - 12, var4 + Client.viewportTempY - var10);
						}

						if (var91.field1137 != -1) {
							var10 += 25;
							HttpMethod.headIconPrayerSprites[var91.field1137].drawTransBgAt(var3 + Client.viewportTempX - 12, var4 + Client.viewportTempY - var10);
						}
					}
				}
				...
				if (Client.hintArrowType == 1 && var0.npcIndexes[var2 - var76] == Client.hintArrowNpcIndex && Client.cycle % 20 < 10) {
					LoginState.method1226(var0, var1, var1.defaultHeight + 15);
					if (Client.viewportTempX > -1) {
