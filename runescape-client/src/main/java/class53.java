...
public class class53 extends Node {
	...
	static final void method1091(WorldView var0) {
		int[] var1 = var0.playerUpdateManager.playerIndexes;

		int var2;
		for (var2 = 0; var2 < var0.playerUpdateManager.playerSize; ++var2) {
		...
		for (var2 = 0; var2 < var0.npcSize; ++var2) {
			int var3 = var0.npcIndexes[var2];
