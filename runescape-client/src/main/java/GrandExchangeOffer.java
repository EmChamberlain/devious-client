...
public class GrandExchangeOffer {
	...
	static final void method7426(int var0, int var1, boolean var2) {
		if (!var2 || var0 != class485.field5007 || DelayFadeTask.field4786 != var1) {
				...
				for (var14 = var10; var11 != var14; var14 += var12) {
					...
					for (int var17 = 0; var17 < 4; ++var17) {
						if (var15 >= 0 && var16 >= 0 && var15 < 104 && var16 < 104) {
							class358.topLevelWorldView.field1349[var17][var13][var14] = class358.topLevelWorldView.field1349[var17][var15][var16];
						} else {
							class358.topLevelWorldView.field1349[var17][var13][var14] = null;
						}
					}
				}
			}

			for (PendingSpawn var18 = (PendingSpawn)class358.topLevelWorldView.field1342.last(); var18 != null; var18 = (PendingSpawn)class358.topLevelWorldView.field1342.previous()) {
			...
			Client.field771 = -1;
			class358.topLevelWorldView.graphicObjects.clear();
